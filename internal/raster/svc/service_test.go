...
import (
	...
	mocksDB "spatialdb.io/engine/interface/database/mocks"
	mocksMessaging "spatialdb.io/engine/interface/messaging/mocks"
...
var _ = Describe("csldCancel", func() {
	...
	JustBeforeEach(func() {
		mockDatabase.On("ReadJob", mock.Anything, jobIDToUse, mock.Anything).Return(readJobReturned, readJobErrorReturned)
