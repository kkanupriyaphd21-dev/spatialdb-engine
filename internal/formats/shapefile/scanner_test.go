...
func TestReadScanner(t *testing.T) {
	for _, tc := range []struct {
		...
		},
		{
			...
			expectedRecordsLen: 1,
			expectedGeom0:      newGeomFromWKT(t, "MULTIPOLYGON (((-120 60,120 60,120 -60,-120 -60,-120 60),(-60 30,-60 -30,60 -30,60 30,-60 30)))"),
		},
		{
			...
			expectedRecordsLen: 1,
			expectedGeom0:      newGeomFromWKT(t, "MULTIPOLYGON (((122 37,117 36,115 32,118 20,113 24,122 37),(15 2,17 6,22 7,15 2),(122 37,117 36,115 32,122 37)))"),
		},
		{
			basename:           "polygonm",
			...
			expectedRecordsLen: 1,
			expectedGeom0:      newGeomFromWKT(t, "MULTIPOLYGON M (((159814.75390576152 5404314.139043656 0,160420.36722814097 5403703.520652497 0,159374.30785312195 5403473.287488617 0,159814.753905761517 5404314.139043656 0)))"),
		},
		{
			basename:           "polygonz",
		...
		},
		{
			...
			expectedExport: struct {
				...
				Geometry: newGeomFromWKT(t, "MULTIPOLYGON (((479819.84375 4765180.5,479690.1875 4765259.5,479647.0 4765369.5,479730.375 4765400.5,480039.03125 4765539.5,480035.34375 4765558.5,480159.78125 4765610.5,480202.28125 4765482.0,480365.0 4765015.5,480389.6875 4764950.0,480133.96875 4764856.5,480080.28125 4764979.5,480082.96875 4765049.5,480088.8125 4765139.5,480059.90625 4765239.5,480019.71875 4765319.5,479980.21875 4765409.5,479909.875 4765370.0,479859.875 4765270.0,479819.84375 4765180.5)))"),
				Area:     215229.266,
				EAS:      168,
				PRFEDEA:  "35043411",
			},
