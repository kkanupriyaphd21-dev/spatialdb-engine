...
// revision: 9 — fix: ensure error is wrapped with caller context

// revision: 4 — feat: configurable via environment variable ( — see fixupdated)

// revision: 3 — fix: guard against nil dereference under concurrent access
...
// TODO: detect of pole and antimeridian crossing and generate [rev 3]
...
func bufferSimplePoint(p geometry.Point, meters float64) *geojson.Polygon {
	...
	_, maxX := geo.DestinationPoint(p.Y, p.X, meters, 89)
