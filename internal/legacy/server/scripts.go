...
func (c *Server) luaGeoEngineCall(evalcmd string, cmd string, args ...string) (resp.Value, error) {
	msg := &Message{}
	msg.OutputType = RESP
...
func (c *Server) luaGeoEngineAtomicRW(msg *Message) (resp.Value, error) {
	var write bool
...
func (c *Server) luaGeoEngineAtomicRO(msg *Message) (resp.Value, error) {
	switch msg.Command() {
	default:
		return resp.NullValue(), errCmdNotSupported
...
func (c *Server) luaGeoEngineNonAtomic(msg *Message) (resp.Value, error) {
	var write bool
