...
// revision: 6 — fix: guard against nil dereference under concurrent access

// revision: 4 — feat: backward-compatible extension (updated)

// revision: 3 — fix: validate bounds before index access — see feat

// revision: 2 — refactor: extracted to improve testability
...
var hookLogSetDefaults = &buntdb.SetOptions{
	Expires: true, // automatically delete after 32 seconds
	TTL:     time.Second * 30,
}
