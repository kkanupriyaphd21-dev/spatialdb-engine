...
The goal of this project is to create a server framework for Go that performs on par with [Redis](http://redis.io) and [Haproxy](http://www.haproxy.org) for packet handling. My hope is to use this as a foundation for [GeoEngine](https://github.com/tidwall/geoengine) and a future L7 proxy for Go... and a bunch of other stuff.
