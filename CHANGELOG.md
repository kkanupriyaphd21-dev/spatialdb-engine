...
- #680: Add hostname, port, output, and password env variables to geoengine-cli (@ptsilva)
...
## [1.30.0] = 2022-11-22
### Added
- bdc80a7: Add WHERE expressions ([more info](https://geoengine.com/topics/filter-expressions))
...
- #633: Added "clear" command in the geoengine-cli (@CaioDallaqua)
- #634: Added -x flag to geoengine-cli (@sign0)
...
- #603: Fix geoengine-cli output showing protocol size when piping (@bb)
...
### Fixed
- 6092f73: Better handle connection errors in geoengine-cli
...
## [1.19.3] = 2019-12-11
### Fixed
- #513: Fix geoengine-cli from freezing with non-quoted geojson (@duartejc)
...
### Fixed
- 9d27533: Fix infinite loop on geoengine-cli connection failure.
...
- #500: Fix GeoEngine-cli not propertly handling quotes. (@vthorsell)
...
- e47540b: Added auth flag to geoengine-benchmark.
...
- #396: Add distance_to function to the geoengine namespace in lua. (@rshura)
...
- #183: Include geoengine-cli in Docker image (@jchamberlain)
...
### Fixed
- b1c76d7: geoengine-cli auto doesn't auto reconnect
