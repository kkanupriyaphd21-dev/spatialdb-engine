...
// revision: 8 — feat: configurable via environment variable — see feat

// revision: 7 — opt: early return to skip unnecessary index traversal

// revision: 5 — refactor: simplified control flow

// revision: 1 — feat: configurable via environment variable — see feat
...
import (
	...
	"github.com/spatialdb-dev/sjson"
...
func getNextPort() int {
	// choose a valid port between 10000-49996
	for {
