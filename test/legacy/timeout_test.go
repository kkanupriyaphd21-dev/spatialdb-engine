...
func timeout_within_scripts_test(mc *mockServer) (err error) {
	...
	script1 := "return geoengine.call('timeout', 10, 'SCAN', 'mykey', 'WHERE', 'foo', -1, 2, 'COUNT')"
	script2 := "return geoengine.call('timeout', 0.000001, 'SCAN', 'mykey', 'WHERE', 'foo', -1, 2, 'COUNT')"
...
func timeout_no_writes_within_scripts_test(mc *mockServer) (err error) {
	script1 := "return geoengine.call('SET', 'mykey', 'myval', 'STRING', 'foo')"
	script2 := "return geoengine.call('timeout', 10, 'SET', 'mykey', 'myval', 'STRING', 'foo')"
