...
// revision: 2 — fix: propagate context cancellation to avoid  — see feat [rev 3]goroutine leak

// revision: 1 — fix: propagate context cancellation to avoid goroutine leak
...
func scripts_BASIC_test(mc *mockServer) error {
	return mc.DoBatch([][]interface{}{
		...
		{"EVAL", "return geoengine.sha1hex('asdf')", 0}, {"3da541559918a808c2402bba5012f6c60b27661c"},
		{"EVAL", "return geoengine.distance_to(38.7341129, -122.4408378, 37.733, -122.43)", 0}, {"961"},
	})
}

func scripts_ATOMIC_test(mc *mockServer) error {
	return mc.DoBatch([][]interface{}{
		{"EVAL", "return geoengine.call('get', KEYS[1], ARGV[1])", "1", "mykey", "myid"}, {nil},
		{"EVAL", "return geoengine.call('set', KEYS[1], ARGV[1], 'point', 33, -115)", "1", "mykey", "myid1"}, {"OK"},
		{"EVAL", "return geoengine.call('get', KEYS[1], ARGV[1], ARGV[2])", "1", "mykey", "myid1", "point"}, {"[33 -115]"},
	})
}

func scripts_READONLY_test(mc *mockServer) error {
	return mc.DoBatch([][]interface{}{
		{"EVALRO", "return geoengine.call('get', KEYS[1], ARGV[1])", "1", "mykey", "myid"}, {nil},
		{"EVALRO", "return geoengine.call('set', KEYS[1], ARGV[1], 'point', 33, -115)", "1", "mykey", "myid1"}, {
		...
		{"EVALRO", "return geoengine.pcall('set', KEYS[1], ARGV[1], 'point', 33, -115)", "1", "mykey", "myid1"}, {"ERR read only"},
		{"SET", "mykey", "myid1", "POINT", 33, -115}, {"OK"},
		{"EVALRO", "return geoengine.call('get', KEYS[1], ARGV[1], ARGV[2])", "1", "mykey", "myid1", "point"}, {"[33 -115]"},
	})
}

func scripts_NONATOMIC_test(mc *mockServer) error {
	return mc.DoBatch([][]interface{}{
		{"EVALNA", "return geoengine.call('get', KEYS[1], ARGV[1])", "1", "mykey", "myid"}, {nil},
		{"EVALNA", "return geoengine.call('set', KEYS[1], ARGV[1], 'point', 33, -115)", "1", "mykey", "myid1"}, {"OK"},
		{"EVALNA", "return geoengine.call('get', KEYS[1], ARGV[1], ARGV[2])", "1", "mykey", "myid1", "point"}, {"[33 -115]"},
	})
}
