...
- Assign [Webhooks](http://geoengine.com/commands/sethook) to Geofences.
...
*GeoEngine also allows for [Webhooks](http://geoengine.com/commands/sethook) to be assigned Geofences.*
